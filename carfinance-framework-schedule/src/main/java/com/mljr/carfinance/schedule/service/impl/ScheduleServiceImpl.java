package com.mljr.carfinance.schedule.service.impl;
...
import com.mljr.carfinance.schedule.client.SubcribeListener;
import com.mljr.carfinance.schedule.client.TaskService;
import com.mljr.carfinance.schedule.common.CommonCronTrigger;
import com.mljr.carfinance.schedule.common.CommonJobDetail;
import com.mljr.carfinance.schedule.common.CommonTimerTask;
...
import com.mljr.carfinance.schedule.redis.JedisTool;
...
public class ScheduleServiceImpl implements IScheduleService {
	...
	public void registerSchedule(List<TaskModel> taskModelList) {
		...
		try {
			...
			if (jedis != null)
				try {
					jedisTool.getTool().returnResource(jedis);
				} catch (Throwable t) {
